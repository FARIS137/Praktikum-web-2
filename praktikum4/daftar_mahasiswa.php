...
<div class="container">
    ...
    <table class="table table-striped table-bordered mt-3 mb-3">
        ...
        <?php    
            ...
            // echo '<td>1</td>';
            // echo '<td>'.$mhs1->nim.'</td>';
            // echo '<td>'.$mhs1->nama.'</td>';
            // echo '<td>TI</td>';
            // echo '<td>2012</td>';
            // echo '<td>'.$ipk = 3.8.'</td>';
            // echo '<td>'.$mhs1->predikat_ipk().'</td>';
            // echo '</tr>';
            // echo '<tr>';
            // echo '<td>2</td>';
            // echo '<td>'.$mhs2->nim.'</td>';
            // echo '<td>'.$mhs2->nama.'</td>';
            // echo '<td>TI</td>';
            // echo '<td>2012</td>';
            // echo '<td>'.$ipk = 3.9.'</td>';
            // echo '<td>'.$mhs2->predikat_ipk().'</td>';
            // echo '</tr>';
            // echo '<tr>';
            // echo '<td>3</td>';
            // echo '<td>'.$mhs3->nim.'</td>';
            // echo '<td>'.$mhs3->nama.'</td>';
            // echo '<td>SI</td>';
            // echo '<td>2010</td>';
            // echo '<td>'.$ipk = 3.46.'</td>';
            // echo '<td>'.$mhs3->predikat_ipk().'</td>';
            // echo '</tr>';
            // echo '<tr>';
            // echo '<td>4</td>';
            // echo '<td>'.$mhs4->nim.'</td>';
            // echo '<td>'.$mhs4->nama.'</td>';
            // echo '<td>SI</td>';
            // echo '<td>2010</td>';
            // echo '<td>'.$ipk = 3.2.'</td>';
            // echo '<td>'.$mhs4->predikat_ipk().'</td>';
            // echo '</tr>';
        ?>
        </tbody>
    </table>
