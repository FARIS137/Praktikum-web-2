...
<div class="form-group row">
    ...
    <div class="col-4">
      <input id="jumlah" name="jumlah" placeholder="Jumlah Pesanan" type="number" class="form-control"> 
    </div> 
...
//Proses ambil data
$proses = $_GET['proses'];
$nama_costumer = $_GET['nama'];
$produk_dipilih = $_GET['produk'];
...
if(!empty($proses)){
echo 'Nama Customer : '.$nama_costumer;
echo '<br/>Produk Pilihan : '.$produk_dipilih;
